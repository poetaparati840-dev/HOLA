...
function showDedicationText() { //seguidores
  ...
  if (!text) {
     text = `Hola vienbenida a este pequellos mensage:
     \n\n.Hola quiero dedicartes estos pequellos detalles desde el primer detalle que te mande asta el utimo.
     \n\nespero que te tomes unos minutos en lo que ves cada uno de los detalles que le e dedicaado en el trascurso que e estado con husted.
     \n\nquiero mas bien pedir a usted señorita de la manera mas respetuosa apriete cada uno de los botones`;  } else {
